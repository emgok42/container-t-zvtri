...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-t-zvtri.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-t-zvtri.containers.anotherwebservice.com/
...
```
git clone git@github.com:emgok42/container-t-zvtri.git
cd container-t-zvtri
```
...
```
docker attach container-t-zvtri
```
